...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 8? 22 15:44:23 2016
...
SOURCES       = main/Card_window.cpp \
		...
		mythread.cpp \
		global.cpp moc_Card_window.cpp \
		moc_main.cpp \
