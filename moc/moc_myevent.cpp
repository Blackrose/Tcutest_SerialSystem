...
QT_MOC_LITERAL(1, 8, 11), // "clearSignal"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "MyEvent\0clearSignal\0"
};
...
void MyEvent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyEvent::clearSignal)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject MyEvent::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MyEvent.data,
      qt_meta_data_MyEvent,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
